...
*   没有类语法，自然不能继承，你可以使用 [prototype.js](http://prototypejs.org/ "http://prototypejs.org/")，或者学习大神 [John Resig 的办法](https://johnresig.com/blog/simple-javascript-inheritance/ "https://johnresig.com/blog/simple-javascript-inheritance/")，看懂这段代码可不太容易；
*   没有 JSON，需要引用第三方库，比如 [JSON3](https://bestiejs.github.io/json3/ "https://bestiejs.github.io/json3/")；
*   没有模块化系统，很晚才出现了遵循 AMD 规范的 [require.js](https://requirejs.org/ "https://requirejs.org/")，兼具打包功能；
*   没有视图框架，所有都是基于模板引擎的，比如 [backbone.js](https://backbonejs.org/ "https://backbonejs.org/")。
