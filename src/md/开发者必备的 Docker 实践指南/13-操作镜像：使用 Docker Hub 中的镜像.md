...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/3/166387eaadcb9fe1~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=816&h=762&s=65318&e=png&b=fdfdfd)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/3/16639074fdc48422~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=816&h=762&s=97212&e=png&b=fefdfd)
...
如果深究 MySQL 是如何实现这样复杂的功能的，大家可以到 MySQL 镜像的 Dockerfile 源码库里，找到 [docker-entrypoint.sh](https://github.com/docker-library/mysql/blob/master/5.7/docker-entrypoint.sh "https://github.com/docker-library/mysql/blob/master/5.7/docker-entrypoint.sh") 这个脚本，所有的秘密正暗藏在其中。MySQL 正是利用了 ENTRYPOINT 指令进行初始化这种任务安排，对容器中的 MySQL 进行初始化的。
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/3/16638f7a60c3c8a9~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=916&h=558&s=69134&e=png&b=ffffff)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/3/16638fbdcfee0b77~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=2558&h=918&s=89388&e=png&b=e6edf5)

在 Docker Hub 中并不直接存放我们用于构建的 Dockerfile 和相关文件，我们必须将 Docker Hub 账号授权到 GitHub 或是 Bitbucket 来从这些代码库中获取 Dockerfile 和相关文件。

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/3/16638fbc9c1ac1c2~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=2558&h=708&s=79510&e=png&b=e3eaf3)

在连接到 GitHub 或 Bitbucket 后，我们就可以选择我们存放 Dockerfile 和相关文件的代码仓库用来创建自动构建了。

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/3/16638fbbd4f6d20a~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1934&h=1034&s=96802&e=png&b=fefefe)

在基本信息填写完成，点击创建按钮后，Docker Hub 就会开始根据我们 Dockerfile 的内容构建镜像了。而此时，我们也能够访问我们镜像专有的详情页面了。

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/3/16638fb9fa6cd7f7~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=2554&h=952&s=137319&e=png&b=ffffff)
