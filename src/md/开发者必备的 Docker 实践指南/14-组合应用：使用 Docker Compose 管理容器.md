...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/10/4/1663e6a38cd88368~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1600&h=704&s=781358&e=png&b=e7e9ee)
...
Docker Compose 的配置文件是一个基于 [YAML](http://yaml.org/ "http://yaml.org/") 格式的文件。关于 YAML 的语法大家可以在网上找到，这里不再细说，总的来说，YAML 是一种清晰、简单的标记语言，你甚至都可以在看过几个例子后摸索出它的语法。
