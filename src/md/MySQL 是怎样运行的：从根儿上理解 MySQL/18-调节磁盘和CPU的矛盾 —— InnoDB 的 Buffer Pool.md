...
![image_1d15mh3d4oadq0e1qpme22u8i61.png-47.4kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/2/1693e86e2b9d6dd1~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1004&h=339&s=48567&e=png&b=ffffff)
...
> 小贴士：  
>   
> 每个控制块大约占用缓存页大小的5%，在MySQL5.7.21这个版本中，每个控制块占用的大小是808字节。而我们设置的innodb\_buffer\_pool\_size并不包含这部分控制块占用的内存空间大小，也就是说InnoDB在为Buffer Pool向操作系统申请连续的内存空间时，这片连续的内存空间一般会比innodb\_buffer\_pool\_size的值大5%左右。
...
![image_1d155te021bmgjt09mo1lln17dum.png-132.6kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/2/1693e86e300173c1~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1010&h=606&s=135745&e=png&b=fefefe)
...
![image_1d1589dpqmt5v1849s7614nu23.png-133.5kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/2/1693e86e2ec4572a~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1010&h=591&s=136665&e=png&b=ffffff)
...
![image_1d15fb53d2lf13ovglg1rnv1h2n2g.png-116.5kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/2/1693e86e2a3fffa3~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1097&h=460&s=119309&e=png&b=fdfbfb)
...
![image_1d15nmrbi19mv1tbk191eoqbmb47e.png-87.2kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/2/1693e86e2abd79c1~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1089&h=444&s=89286&e=png&b=f3f0e5)
...
![image_1d15r7te41q58egj1b4plh615ug7r.png-125.5kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/2/1693e86e2a5de8f2~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1112&h=553&s=128507&e=png&b=eceadb)
...
> 小贴士：  
>   
> 为什么不允许在服务器运行过程中修改innodb\_buffer\_pool\_chunk\_size的值？还不是因为innodb\_buffer\_pool\_chunk\_size的值代表InnoDB向操作系统申请的一片连续的内存空间的大小，如果你在服务器运行过程中修改了该值，就意味着要重新向操作系统申请连续的内存空间并且将原先的缓存页和它们对应的控制块复制到这个新的内存空间中，这是十分耗时的操作！  
>   
> 另外，这个innodb\_buffer\_pool\_chunk\_size的值并不包含缓存页对应的控制块的内存空间大小，所以实际上InnoDB向操作系统申请连续内存空间时，每个chunk的大小要比innodb\_buffer\_pool\_chunk\_size的值大一些，约5%。
