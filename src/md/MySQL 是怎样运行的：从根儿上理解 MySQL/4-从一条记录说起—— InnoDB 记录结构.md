...
![image_1c9g4t114n0j1gkro2r1h8h1d1t16.png](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e8fafc21aa~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=783&h=250&s=43461&e=png&b=fefdfd)
...
![image_1c9gbruvo504dlg1qsf19nbeu878.png](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e8fb363bb4~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1004&h=192&s=37847&e=png&b=fefefe)
...
![image_1c9grq2b2jok1062t8tov21lqjbj.png](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e8fe4ee6b0~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=742&h=239&s=43624&e=png&b=fefdfd)
...
2.  如果表中没有允许存储 _**NULL**_ 的列，则 _NULL值列表_ 也不存在了，否则将每个允许存储`NULL`的列对应一个二进制位，二进制位按照列的顺序逆序排列，二进制位表示的意义如下：
    ...
    *   二进制位的值为`0`时，代表该列的值不为`NULL`。
    ...
    ![image_1c9g88mtt1tj51ua1qh51vjo12pg5k.png-10.4kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e9018133f7~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=247&h=229&s=10657&e=png&b=ffffff)
...
3.  `MySQL`规定`NULL值列表`必须用整数个字节的位表示，如果使用的二进制位个数不是整数个字节，则在字节的高位补`0`。
    ...
    ![image_1c9g8g27b1bdlu7t187emsc46s61.png-19.4kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e901669f45~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=374&h=301&s=19883&e=png&b=ffffff)
...
*   对于第一条记录来说，`c1`、`c3`、`c4`这3个列的值都不为`NULL`，所以它们对应的二进制位都是`0`，画个图就是这样：
    ...
    ![image_1c9g8m05b19ge1c8v2bf163djre6e.png-21.5kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e901befeac~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=346&h=308&s=22040&e=png&b=ffffff) 所以第一条记录的`NULL值列表`用十六进制表示就是：`0x00`。
    
*   对于第二条记录来说，`c1`、`c3`、`c4`这3个列中`c3`和`c4`的值都为`NULL`，所以这3个列对应的二进制位的情况就是：
    
    ![image_1c9g8ps5c1snv1bhj3m48151sfl6r.png-20.6kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e944a8af0c~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=332&h=316&s=21067&e=png&b=ffffff)
...
![image_1c9grs9m4co8134u1t2rjhm1q6rc0.png-39kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e95903144f~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=729&h=233&s=39932&e=png&b=fefdfd)

##### 记录头信息

除了`变长字段长度列表`、`NULL值列表`之外，还有一个用于描述记录的`记录头信息`，它是由固定的`5`个字节组成。`5`个字节也就是`40`个二进制位，不同的位代表不同的意思，如图：

![image_1c9geiglj1ah31meo80ci8n1eli8f.png-29.5kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e97718ef01~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1174&h=244&s=30222&e=png&b=fefefe)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/2/24/17075b82cb070959~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1172&h=593&s=173144&e=png&b=fefefe)
...
![image_1c9h256f9nke14311adhtu61ie2dn.png-92kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e973b70372~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1094&h=354&s=94249&e=png&b=fefdfd)
...
![image_1c9jdkga71kegkjs14o111ov1ce3kn.png-12.5kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e985c8d9a7~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=322&h=152&s=12767&e=png&b=fefdfd)
...
![image_1c9jeb6defgf1o981lgfciokjl4.png-43.1kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e973ff4fde~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=545&h=459&s=44156&e=png&b=fefefe)
...
![image_1c9h896lcuqi16081qub1v8c12jkft.png-36.2kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e99a69ba3d~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=618&h=251&s=37063&e=png&b=fefdfd)
...
![image_1c9h8tnav166c187m1nhap61153qgn.png-91.6kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e9a5b7c847~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1046&h=337&s=93778&e=png&b=fefdfd)
...
![image_1d48e3imu1vcp5rsh8cg0b1o169.png-149kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e9aab47ea5~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=1160&h=627&s=152562&e=png&b=fcfbf9)
...
![image_1conbskr7apj19ns1d194vs1buo1t.png-35.8kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e9a5d5637a~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=951&h=213&s=36684&e=png&b=fefdfd)
...
![image_1conbtnmr1sg1hao1nf41pi1eb72a.png-29.9kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e9b2c2b71e~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=791&h=219&s=30573&e=png&b=fefdfd)
...
3.  `InnoDB`目前定义了4种行格式
    ...
    *   COMPACT行格式
        ...
        具体组成如图： ![image_1c9g4t114n0j1gkro2r1h8h1d1t16.png-42.4kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e8fafc21aa~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=783&h=250&s=43461&e=png&b=fefdfd)
        
    *   Redundant行格式
        
        具体组成如图： ![image_1ctfppb4c1cng1m8718l91760jde9.png-36.2kB](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/3/12/169710e9ca9cbeb5~tplv-t2oaga2asx-jj-mark:1600:0:0:0:q75.image#?w=618&h=251&s=37063&e=png&b=fefdfd)
